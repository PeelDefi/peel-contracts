...
contract PShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("PSHARE", "PSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 PEEL Share for initial pools deployment
